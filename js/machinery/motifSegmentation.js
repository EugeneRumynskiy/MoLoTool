...
function makeSegmentation(sites, seqLength) {
...
function splitSitesIntoSortedPoints(sites) {
    var points = [];
...
function initSiteInSegment(sitesLength) {
    var ifSiteInSegment = {};
...
function checkPointType(point, typeToCheck) {
    try {
...
function getSegmentEdgePosition(point, pointIs) {
 ...
 */
function sitesInSegment(ifSiteInSegment, sites) {
    var sitesIn = [], site;
